...
int 	get_min_price( Products[SIZE_ARRAY], int );
...
int main(){
	...
	max_price( product );
	index_min_price = get_min_price( product, SIZE_ARRAY );

	printf( "The index for product with min price is %d \n", index_min_price );
...
int get_min_price( Products product[SIZE_ARRAY], int size ){
